...
<?php
  if ($this->session->userdata('logged_in') == TRUE) {
    $links = '<a class="ui inverted button" href="'.base_url().'index.php/welcome/logout">Log Out</a>';
    $links2 = '<div class="item">
          <a class="ui button" href="'.base_url().'index.php/welcome/logout">Log Out</a>
        </div>';
  } else {
...
<!-- Following Menu -->
  <header class="ui large top fixed hidden menu">
    <div class="ui container">
      <a href="<?php echo base_url(); ?>index.php/welcome" class="active item">Home</a>

      <a href="<?php echo base_url(); ?>index.php/product_c" class="item">Products</a>
...
<div class="ui right vertical large very wide sidebar menu cart_sidebar">
  ...
  <div class="item">
    Finished shopping?   
    <a class="ui button" href="<?php echo base_url(); ?>index.php/welcome/cart_checkout" >Check out</a>
  </div>
  </div>
</div>
...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment">
    ...
    <div class="ui text container">
      ...
      <div class="ui segments add_to_cart">
        <form id="cart" action="<?php echo base_url(); ?>index.php/welcome/add_to_cart" method="post" enctype="multipart/form-data" >
  ...
  <div class="ui vertical stripe quote segment">
    ...
    <div class="ui bottom attached segment filter_bar">
      ...
      <a href="<?php echo base_url(); ?>index.php/products_c" class="ui button">
        All
      </a>
      <a href="<?php echo base_url(); ?>index.php/products_c/display_products/burger" class="ui button">
        Burger
      </a>
      <a href="<?php echo base_url(); ?>index.php/products_c/display_products/pizza" class="ui button">
        Pizza
      </a>
      <a href="<?php echo base_url(); ?>index.php/products_c/display_products/pork" class="ui button">
        Pork
      </a>
      <a href="<?php echo base_url(); ?>index.php/products_c/display_products/chicken" class="ui button">
        Chicken
      </a>
